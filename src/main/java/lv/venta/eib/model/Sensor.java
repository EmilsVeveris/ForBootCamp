...
public class Sensor extends Component {
	...
	public Sensor(@Size(min = 0, max = 15) String componentId, @Size(min = 0, max = 80) String description,
			...
			@Min(0) float supplyVoltage, sensorType type) {
